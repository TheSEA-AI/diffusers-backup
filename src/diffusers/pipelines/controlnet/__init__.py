...
try:
    ...
    _import_structure["pipeline_controlnet_sd_xl"] = ["StableDiffusionXLControlNetPipeline", "CustomStableDiffusionXLControlNetPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_controlnet_sd_xl import StableDiffusionXLControlNetPipeline, CustomStableDiffusionXLControlNetPipeline
